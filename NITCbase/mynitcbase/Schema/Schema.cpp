...
int Schema::createRel(char relName[],int nAttrs, char attrs[][ATTR_SIZE],int attrtype[])
{
  ...
  relCatRecord[RELCAT_NO_SLOTS_PER_BLOCK_INDEX+1].nVal = 1; //modification with no of blocks in relation
...
int Schema::dropIndex(char *relName, char *attrName) {
  ...
  if(AttrCacheTable::getAttrCatEntry(relId, attrName, &attrCatEntryBuffer) != SUCCESS) return E_ATTRNOTEXIST;
