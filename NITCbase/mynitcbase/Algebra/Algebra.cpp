...
int Algebra::select(char srcRel[ATTR_SIZE], char targetRel[ATTR_SIZE], char attr[ATTR_SIZE], int op, char strVal[ATTR_SIZE]) {
  ...
  int srcNoAttrs =  relCatEntryBuffer.numAttrs /* the no. of attributes present in src relation */ ;
...
int Algebra::join(char srcRelation1[ATTR_SIZE], char srcRelation2[ATTR_SIZE], char targetRelation[ATTR_SIZE], char attribute1[ATTR_SIZE], char attribute2[ATTR_SIZE]) {
  ...
  // if either of the two source relations is not oMIDDLE_INDEX_INTERNALpen
  //     return E_RELNOTOPEN
  ...
  int numOfAttributes1 = relCatEntryBuf1.numAttrs /* number of attributes in srcRelation1 */;
  int numOfAttributes2 = relCatEntryBuf2.numAttrs /* number of attributes in srcRelation2 */;
  ...
  int targetNumAttrs = numOfAttributes1 + numOfAttributes2 - 1;
  ...
  char targetRelAttrNames[targetNumAttrs][ATTR_SIZE];
  int targetRelAttrTypes[targetNumAttrs];
  ...
  ret = Schema::createRel(targetRelation, targetNumAttrs, targetRelAttrNames, targetRelAttrTypes);
  ...
  Attribute targetRecord[targetNumAttrs];
