...
int IndInternal::getEntry(void *ptr, int indexNum) {
  ...
  struct InternalEntry *intEntry = (struct InternalEntry *)ptr;
  ...
  */
  ...
  memcpy(&(intEntry->lChild), entryPtr, sizeof(int32_t));
  memcpy(&(intEntry->attrVal), entryPtr + 4, sizeof(Attribute));
  memcpy(&(intEntry->rChild), entryPtr + 20, 4);
